...
Playercontainer.addEventListener("mousemove", (e) => {
  let xAxis = (window.innerWidth / 3 - e.pageX)/40 ;
  let yAxis = (window.innerHeight / 3 - e.pageY)/40;
  card.style.transform = `rotateY(${xAxis}deg) rotateX(${yAxis}deg)`;
});
//Animate In
Playercontainer.addEventListener("mouseenter", (e) => {
  card.style.transition = "none";
  image.style.transform = "translateZ(80px)";
  playerControl.style.transform = "translateZ(50px)";
...
Playercontainer.addEventListener("mouseleave", (e) => {
  ...
  playerControl.style.transform = "translateZ(0px)";
...
const songs = [
  {
    name: 'music-1',
    displayName: 'Latin Lover',
    artist: 'Ahjay Stelino',
  },
  {
    name: 'music-2',
    displayName: 'G Easy Type',
    artist: 'Arulo',
  },
  {
    name: 'music-3',
